import { Component, OnChanges, Input, Output, EventEmitter, ElementRef, SimpleChanges, HostListener, ChangeDetectorRef } from '@angular/core';
import { CommonModule } from '@angular/common';
import { SafeResourceUrl, DomSanitizer, SafeStyle } from '@angular/platform-browser';
import { NgxGalleryAction } from '../models/ngx-gallery-action.model';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, NgxGalleryActionComponent, NgxGalleryArrowsComponent]
})
export class NgxGalleryThumbnailsComponent implements OnChanges {
  ...
  constructor(private sanitization: DomSanitizer, private elementRef: ElementRef,
      private helperService: NgxGalleryHelperService, private cdr: ChangeDetectorRef) {}
