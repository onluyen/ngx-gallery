import { Component, OnInit, OnChanges, Input, Output, EventEmitter, ElementRef, SimpleChanges, HostListener, ChangeDetectorRef } from '@angular/core';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, NgxGalleryActionComponent, NgxGalleryBulletsComponent, NgxGalleryArrowsComponent]
})
